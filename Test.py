...
# Assuming 'df' is your DataFrame and 'Alabama' is the column with the data.

# Create lagged features for the sliding window
for i in range(1, window_size + 1):
    df[f'Alabama_lag_{i}'] = df['Alabama'].shift(i)
...
df.drop('Alabama', axis=1, inplace=True)

print(df.head())
# Now df contains your features and you can proceed with train/test split and modeling

df.to_excel('C:\\Users\\mtpv1\\Downloads\\processed_data.xlsx', index=False)